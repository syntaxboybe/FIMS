                            ...
                            <div class="mb-6">
                                ...
                                <div class="mt-1 flex items-center">
                                    ...
                                    <input type="file" name="{{ $setting->key }}" id="{{ $setting->key }}"
                                        class="mt-1 focus:ring-indigo-500 dark:focus:ring-frappe-lavender focus:border-indigo-500 dark:focus:border-frappe-lavender block shadow-sm sm:text-sm border-gray-300 dark:border-frappe-surface1 dark:bg-frappe-mantle dark:text-frappe-text rounded-md">
                                </div>
