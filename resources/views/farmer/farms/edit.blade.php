<x-app-layout>
    <x-slot name="header">
        <div class="flex justify-between items-center">
            ...
            <a href="{{ route('farmer.farms.show', $farm) }}" class="bg-gray-500 hover:bg-gray-600 dark:bg-frappe-surface1 dark:hover:bg-frappe-surface2 text-white dark:text-frappe-text font-bold py-2 px-4 rounded">
                ...
                <div class="p-6 text-gray-900 dark:text-frappe-text">
                    <form method="POST" action="{{ route('farmer.farms.update', $farm) }}">
                        ...
                        <div class="mt-4">
                            ...
                            <textarea id="address" name="address" class="block mt-1 w-full border-gray-300 dark:border-frappe-surface1 dark:bg-frappe-mantle dark:text-frappe-text focus:border-indigo-500 dark:focus:border-frappe-lavender focus:ring-indigo-500 dark:focus:ring-frappe-lavender rounded-md shadow-sm">{{ old('address', $farm->address) }}</textarea>
